import { select as t, event as e } from 'd3-selection';
import { scaleLinear as n } from 'd3-scale';
import { axisBottom as r } from 'd3-axis';
import { line as i } from 'd3-shape';
import { drag as a } from 'd3-drag';
import { range as o } from 'd3-array';
function c(t, e) {
...
var m = { emitDelay: 10, strictMode: !1 },
  x = (function () {
    function t() {
      var e =
      ...
      var n = void 0,
        r = void 0;
      (n = e.hasOwnProperty('emitDelay') ? e.emitDelay : m.emitDelay),
        (this._emitDelay = n),
        (r = e.hasOwnProperty('strictMode') ? e.strictMode : m.strictMode),
        (this._strictMode = r),
        (this._listeners = {}),
        (this.events = []);
    }
      ...
      (h = [
        {
          ...
          value: function () {
            var e = this.width,
              ...
              i = this.margin,
              a = this.target;
            (this.chartWidth = e - i.left - i.right),
              ...
              (this.xScale = n().domain([0, 100]).range([0, this.chartWidth])),
              (this.yScale = n().domain([0, 100]).range([this.chartHeight, 0])),
              this.normalizeData();
          },
        },
        {
          ...
          value: function () {
              ...
              o = a().on('drag', function (n) {
                ...
                if (
                  (a < 0
                    ? (i.emit('home', n), (a = 0))
                    : a > i.chartWidth &&
                      ((a = i.chartWidth), i.emit('end', n)),
                  !i.preview)
                ) {
                  var o = i.xScale.invert(a);
                  (n.x = a), (n.y = i.yScale(b(o)));
                  var c =
                      ((r = i.yScale.invert(n.y)),
                      (25 * (2 * Math.asin((r - 50) / 50) + Math.PI)) /
                        Math.PI),
                    s = { x: o, y: c },
                    l = t(this).attr(
                      'transform',
            ...
            (r = this.preview
              ...
              r
                ...
                .attr('x', function (t) {
                  return k(t.size, n.xScale.invert(t.x));
                })
                .style('text-anchor', function (t) {
                  return O(n.xScale.invert(t.x)) ? 'end' : 'start';
                })
                .attr('y', 5);
          },
        },
        ...
        },
        {
          ...
          value: function () {
            var t = this;
            (this.mainLineCurvePoints = o(0, 100, 0.1).map(function (t) {
              return { x: t, y: b(t) };
            })),
              (this.line = i()
                .x(function (e) {
          ...
          value: function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : 5;
            (this.bottomLine = r(this.xScale).ticks(0).tickSize(0)),
              this.svg
                .append('g')
