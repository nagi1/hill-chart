!(function (t, n) {
  ...
  function l(t) {
    return function () {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === s && n.documentElement.namespaceURI === s
        ? n.createElement(t)
  ...
  function v(t, n, e, i, r, o) {
    for (var a, u = 0, s = n.length, c = o.length; u < c; ++u)
      (a = n[u]) ? ((a.__data__ = o[u]), (i[u] = a)) : (e[u] = new m(t, o[u]));
    for (; u < s; ++u) (a = n[u]) && (r[u] = a);
  }
  function x(t, n, e, i, r, o, a) {
    var u,
      s,
      c,
      h = {},
  ...
  function j(t, n) {
    for (var e = L(t), i = -1, r = n.length; ++i < r; ) e.add(n[i]);
  }
  function z(t, n) {
    for (var e = L(t), i = -1, r = n.length; ++i < r; ) e.remove(n[i]);
  }
  function q(t) {
    return function () {
      j(this, t);
  ...
  function V(t, n) {
    return function () {
      (n.apply(this, arguments) ? j : z)(this, t);
    };
  }
  function X() {
    this.textContent = '';
  ...
  function st(t, n, e) {
    var i = et.hasOwnProperty(t.type) ? rt : ot;
  ...
  pt.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (
        var n = this._groups, e = n.length, i = [], r = [], o = 0;
        o < e;
        ++o
      )
    ...
    data: function (t, n) {
      ...
      for (
        ...
        for (var d, m, w = 0, M = 0; w < p; ++w)
          if ((d = y[w])) {
            for (w >= M && (M = w + 1); !(m = g[M]) && ++M < p; );
            d._next = m || null;
          }
      }
      return ((a = new pt(a, i))._enter = u), (a._exit = s), a;
    },
    enter: function () {
      return new pt(this._enter || this._groups.map(d), this._parents);
    },
    exit: function () {
      return new pt(this._exit || this._groups.map(d), this._parents);
    },
    join: function (t, n, e) {
      var i = this.enter(),
        r = this,
    ...
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each(
            (null == n ? D : 'function' == typeof n ? U : A)(
              t,
              n,
              null == e ? '' : e
            )
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? P : 'function' == typeof n ? Y : F)(t, n))
        : this.node()[t];
    },
    classed: function (t, n) {
      var e = H(t + '');
      if (arguments.length < 2) {
        for (var i = L(this.node()), r = -1, o = e.length; ++r < o; )
          if (!i.contains(e[r])) return !1;
        return !0;
      }
      return this.each(('function' == typeof n ? V : n ? q : I)(e, n));
    },
    text: function (t) {
      return arguments.length
        ? this.each(null == t ? X : ('function' == typeof t ? R : W)(t))
        : this.node().textContent;
    },
    html: function (t) {
      return arguments.length
        ? this.each(null == t ? B : ('function' == typeof t ? $ : Z)(t))
        : this.node().innerHTML;
    },
    raise: function () {
      return this.each(G);
    ...
    append: function (t) {
      var n = 'function' == typeof t ? t : _(t);
      return this.select(function () {
        return this.appendChild(n.apply(this, arguments));
      });
    },
    insert: function (t, n) {
      var e = 'function' == typeof t ? t : _(t),
        i = null == n ? J : 'function' == typeof n ? n : y(n);
      return this.select(function () {
    ...
    on: function (t, n, e) {
      var i,
        ...
        a = o.length;
      if (!(arguments.length < 2)) {
        for (u = n ? st : ut, null == e && (e = !1), i = 0; i < a; ++i)
          this.each(u(o[i], n, e));
        return this;
      }
    ...
    dispatch: function (t, n) {
      return this.each(('function' == typeof n ? ft : lt)(t, n));
    },
  };
  var gt = 0;
  function dt() {
  ...
  function xt(t) {
    var n = mt();
    return n.changedTouches && (n = n.changedTouches[0]), vt(t, n);
  }
  function wt(t, n, e) {
    arguments.length < 3 && ((e = n), (n = mt().changedTouches));
    for (var i, r = 0, o = n ? n.length : 0; r < o; ++r)
      if ((i = n[r]).identifier === e) return vt(t, i);
    return null;
  }
  function Mt(t, n) {
    return t < n ? -1 : t > n ? 1 : t >= n ? 0 : NaN;
  ...
  function At(t, n, e) {
    var i = (n - t) / Math.max(0, e),
      ...
      o = i / Math.pow(10, r);
    return r >= 0
      ? (o >= Nt ? 10 : o >= Ct ? 5 : o >= Dt ? 2 : 1) * Math.pow(10, r)
      : -Math.pow(10, -r) / (o >= Nt ? 10 : o >= Ct ? 5 : o >= Dt ? 2 : 1);
  }
  function Ut(t, n) {
      ...
      Et ||
        ...
        (function (t, n) {
          !(function (t) {
            ...
            function X(t) {
              ...
              return (
                i === r && r === o
                  ? (n = e = a)
                  : ((n = Z(
                      (0.4360747 * i + 0.3850649 * r + 0.1430804 * o) / L
                    )),
                    (e = Z(
                      (0.0139322 * i + 0.0971045 * r + 0.7141733 * o) / j
                    ))),
            ...
            function Z(t) {
              return t > V ? Math.pow(t, 1 / 3) : t / I + z;
            }
            function $(t) {
              return t > q ? t * t * t : I * (t - z);
            }
            function G(t) {
              return (
                255 *
    ...
    !(function (t, n) {
      ...
      function z(t, n, e, i) {
        ...
        function s(t, n, e, i, o, a) {
          ...
          } else (1 === e && 1 === i) || o.push(r(o) + 'scale(' + e + ',' + i + ')');
        }
        return function (n, e) {
          var i = [],
            r = [];
  ...
  function zt(t, n, e) {
    var i = t[0],
      ...
      a = n[1];
    return (
      r < i ? ((i = jt(r, i)), (o = e(a, o))) : ((i = jt(i, r)), (o = e(o, a))),
      function (t) {
        return o(i(t));
      }
    );
  ...
  function qt(t, n, e) {
    ...
    for (
      ...
      (r[a] = jt(t[a], t[a + 1])), (o[a] = e(n[a], n[a + 1]));
    return function (n) {
      var e = St(t, n, 1, i) - 1;
      return o[e](r[e](n));
    };
  ...
  function Vt() {
    ...
    return (
      (l.invert = function (e) {
        return c(
          n((o || (o = i(u, a.map(t), Pt.exports.interpolateNumber)))(e))
        );
      }),
      (l.domain = function (t) {
        return arguments.length ? ((a = Array.from(t, Ht)), h()) : a.slice();
      }),
      (l.range = function (t) {
        return arguments.length ? ((u = Array.from(t)), h()) : u.slice();
      }),
      (l.rangeRound = function (t) {
        return (u = Array.from(t)), (s = Pt.exports.interpolateRound), h();
      }),
      (l.clamp = function (t) {
        return arguments.length ? ((c = !!t || Ot), h()) : c !== Ot;
      }),
    ...
    var r,
      o = (function (t, n, e) {
        var i = Math.abs(n - t) / Math.max(0, e),
          ...
          o = i / r;
        return (
          o >= Nt ? (r *= 10) : o >= Ct ? (r *= 5) : o >= Dt && (r *= 2),
          n < t ? -r : r
        );
      })(t, n, e);
    switch ((i = Wt.exports.formatSpecifier(null == i ? ',f' : i)).type) {
      case 's':
        var a = Math.max(Math.abs(t), Math.abs(n));
        return (
          null != i.precision ||
            isNaN((r = Wt.exports.precisionPrefix(o, a))) ||
            (i.precision = r),
          Wt.exports.formatPrefix(i, a)
        );
      case '':
      case 'e':
      case 'g':
      ...
      case '%':
        null != i.precision ||
          isNaN((r = Wt.exports.precisionFixed(o))) ||
          (i.precision = r - 2 * ('%' === i.type));
    }
    return Wt.exports.format(i);
  }
  function Bt(t) {
    var n = t.domain;
    return (
      ...
      (t.tickFormat = function (t, e) {
        var i = n();
        return Rt(i[0], i[i.length - 1], null == t ? 10 : t, e);
      }),
      (t.nice = function (e) {
        null == e && (e = 10);
        var i,
    ...
    return (
      ...
      e &&
        ((r.count = function (n, i) {
          return (
            $t.setTime(+n), Gt.setTime(+i), t($t), t(Gt), Math.floor(e($t, Gt))
          );
        }),
        (r.every = function (t) {
          return (
  ...
  var Kt = Jt.range,
    ...
    sn = Qt(
      function (t) {
        t.setTime(t - t.getMilliseconds() - t.getSeconds() * tn);
      },
      function (t, n) {
        t.setTime(+t + n * nn);
      },
    ...
    hn = Qt(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - t.getSeconds() * tn - t.getMinutes() * nn
        );
      },
      function (t, n) {
        t.setTime(+t + n * en);
    ...
    fn = Qt(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * nn) / rn
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  function pn(t) {
    return Qt(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * nn) / on
        );
      }
    );
  }
      ...
      function o(t) {
        ...
        function Lt(t, o) {
          return function (a) {
              ...
              'w' in c || (c.w = 1),
                'Z' in c
                  ? ((s = (u = i(r(c.y, 0, 1))).getUTCDay()),
                    (u =
                      s > 4 || 0 === s ? n.utcMonday.ceil(u) : n.utcMonday(u)),
            ...
            } else ('W' in c || 'U' in c) && ('w' in c || (c.w = 'u' in c ? c.u % 7 : 'W' in c ? 1 : 0), (s = 'Z' in c ? i(r(c.y, 0, 1)).getUTCDay() : e(r(c.y, 0, 1)).getDay()), (c.m = 0), (c.d = 'W' in c ? ((c.w + 6) % 7) + 7 * c.W - ((s + 5) % 7) : c.w + 7 * c.U - ((s + 6) % 7)));
            return 'Z' in c
  ...
  function pe(t, n) {
    ...
    function l(l) {
      var f = null == i ? (n.ticks ? n.ticks.apply(n, e) : n.domain()) : i,
        _ = null == r ? (n.tickFormat ? n.tickFormat.apply(n, e) : ue) : r,
        p = Math.max(o, 0) + u,
        y = n.range(),
        g = +y[0] + 0.5,
        d = +y[y.length - 1] + 0.5,
        m = (n.bandwidth ? fe : le)(n.copy()),
      ...
      (x = x.merge(
        ...
        l !== v &&
          ...
          b.attr('opacity', se).attr('transform', function (t) {
    ...
    return (
      ...
      (l.ticks = function () {
        return (e = ae.call(arguments)), l;
      }),
      (l.tickArguments = function (t) {
        return arguments.length
          ? ((e = null == t ? [] : ae.call(t)), l)
          : e.slice();
      }),
      (l.tickValues = function (t) {
        return arguments.length
          ? ((i = null == t ? null : ae.call(t)), l)
          : i && i.slice();
      }),
  ...
  xe.prototype = we.prototype = {
      ...
      if (null === this._x1)
        ...
        if (Math.abs(h * u - s * c) > me && r) {
          var f = e - o,
            ...
            g = Math.sqrt(p),
            d = Math.sqrt(l),
            m = r * Math.tan((ge - Math.acos((p + l - y) / (2 * g * d))) / 2),
            v = m / d,
            x = m / g;
          Math.abs(v - 1) > me &&
    ...
    arc: function (t, n, e, i, r, o) {
      ...
      null === this._x1
        ? (this._ += 'M' + s + ',' + c)
        : (Math.abs(this._x1 - s) > me || Math.abs(this._y1 - c) > me) &&
          (this._ += 'L' + s + ',' + c),
        e &&
          (l < 0 && (l = (l % de) + de),
          l > ve
  ...
  function Ne() {
    ...
    return (
      (a.x = function (n) {
        return arguments.length
          ? ((t = 'function' == typeof n ? n : Me(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = 'function' == typeof t ? t : Me(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Me(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function Ue(t, n) {
    (this._basis = new Ae(t)), (this._beta = n);
  }
  function Ee(t, n, e) {
    t._context.bezierCurveTo(
  ...
  function qe(t, n, e) {
    var i = t._x1 - t._x0,
      ...
      u = (o * r + a * i) / (i + r);
    return (
      (ze(o) + ze(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function Ie(t, n) {
  ...
  (be.prototype = {
    ...
    (function t(n) {
      function e(t) {
        return 1 === n ? new Ae(t) : new Ue(t, n);
      }
      return (
        (e.beta = function (n) {
          return t(+n);
    ...
    (function t(n) {
      function e(t) {
        return n ? new Le(t, n) : new Pe(t, 0);
      }
      return (
        (e.alpha = function (n) {
          return t(+n);
    ...
    (function t(n) {
      function e(t) {
        return n ? new Oe(t, n) : new Fe(t, 0);
      }
      return (
        (e.alpha = function (n) {
          return t(+n);
    ...
    (function t(n) {
      function e(t) {
        return n ? new je(t, n) : new Ye(t, 0);
      }
      return (
        (e.alpha = function (n) {
          return t(+n);
      ...
      lineEnd: function () {
        switch (this._point) {
          case 2:
            ...
            break;
          case 3:
            Ve(this, this._t0, Ie(this, this._t0));
        }
        (this._line || (0 !== this._line && 1 === this._point)) &&
          this._context.closePath(),
          (this._line = 1 - this._line);
        ...
        if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
          switch (this._point) {
            ...
            case 1:
              ...
              break;
            case 2:
              (this._point = 3), Ve(this, Ie(this, (e = qe(this, t, n))), e);
              break;
            default:
              Ve(this, this._t0, (e = qe(this, t, n)));
          }
          (this._x0 = this._x1),
            (this._x1 = t),
            (this._y0 = this._y1),
    ...
    (Object.create(Xe.prototype).point = function (t, n) {
      Xe.prototype.point.call(this, n, t);
    });
  var We = { exports: {} };
  function Re() {
  ...
  function Ze(t) {
    var n = t.document.documentElement,
      e = yt(t).on('dragstart.drag', Be, !0);
    'onselectstart' in n
      ? e.on('selectstart.drag', Be, !0)
  ...
  function Ge(t, n, e, i, r, o, a, u, s, c) {
    (this.target = t),
      (this.type = n),
      (this.subject = e),
      (this.identifier = i),
  ...
  function Qe() {
    return !it.ctrlKey && !it.button;
  }
  function Je() {
    return this.parentNode;
  }
  function Ke(t) {
    return null == t ? { x: it.x, y: it.y } : t;
  }
  function ti() {
  ...
  function ni() {
    var t,
      ...
      u = ti,
      s = {},
      c = We.exports.dispatch('start', 'drag', 'end'),
      h = 0,
      l = 0;
    function f(t) {
    ...
    function _() {
      if (!i && r.apply(this, arguments)) {
        var a = v('mouse', o.apply(this, arguments), xt, this, arguments);
        a &&
          (yt(it.view).on('mousemove.drag', p, !0).on('mouseup.drag', y, !0),
          Ze(it.view),
          Re(),
          (e = !1),
          (t = it.clientX),
    ...
    function y() {
      yt(it.view).on('mousemove.drag mouseup.drag', null),
        (function (t, n) {
          var e = t.document.documentElement,
            i = yt(t).on('dragstart.drag', null);
          n &&
            (i.on('click.drag', Be, !0),
            setTimeout(function () {
    ...
    function g() {
      if (r.apply(this, arguments)) {
        var t,
          ...
          a = e.length;
        for (t = 0; t < a; ++t)
          (n = v(e[t].identifier, i, wt, this, arguments)) &&
            (Re(), n('start'));
      }
    }
    function d() {
      var t,
        ...
        e = it.changedTouches,
        i = e.length;
      for (t = 0; t < i; ++t) (n = s[e[t].identifier]) && (Be(), n('drag'));
    }
    function m() {
      var t,
        n,
    ...
    function v(t, n, e, i, r) {
      var o,
        ...
        p = c.copy();
      if (
        ct(new Ge(f, 'beforestart', o, t, h, _[0], _[1], 0, 0, p), function () {
          return (
            null != (it.subject = o = a.apply(i, r)) &&
    ...
    return (
      (f.filter = function (t) {
        return arguments.length
          ? ((r = 'function' == typeof t ? t : $e(!!t)), f)
          : r;
      }),
      (f.container = function (t) {
        return arguments.length
          ? ((o = 'function' == typeof t ? t : $e(t)), f)
          : o;
      }),
      (f.subject = function (t) {
        return arguments.length
          ? ((a = 'function' == typeof t ? t : $e(t)), f)
          : a;
      }),
      (f.touchable = function (t) {
        return arguments.length
          ? ((u = 'function' == typeof t ? t : $e(!!t)), f)
          : u;
      }),
      (f.on = function () {
    ...
    ui = (function (e) {
      function i(t, n) {
        ...
        return (
          ...
          (i.width = ai.width),
          (i.height = ai.height),
          (i.preview = ai.preview),
          (i.darkMode = ai.darkMode),
          (i.backgroundColor = ai.backgroundColor),
          (i.footerText = ai.footerText),
          (i.margin = ai.margin),
          (i.chartWidth = 0),
          (i.chartHeight = 0),
          ...
          (i.xScale = Zt()),
          (i.yScale = Zt()),
          (i.bottomLine = ye(i.xScale)),
          (i.mainLineCurvePoints = []),
          (i.line = Ne().x(0).y(0)),
          Object.assign(i, ai, { data: t }, n),
          i.init(),
          i
        );
      }
      return (
        ...
        (i.prototype.init = function () {
          ...
          (this.backgroundColor = s ? 'transparent' : c),
            ...
            (this.xScale = Zt().domain([0, 100]).range([0, this.chartWidth])),
            (this.yScale = Zt().domain([0, 100]).range([this.chartHeight, 0])),
            this.normalizeData();
        }),
        ...
        (i.prototype.renderGroup = function () {
            ...
            r = ni()
              .on('drag', function (t) {
                ...
                !e || e < 0
                  ? ((e = 0),
                    i.emit(
                      'home',
                      n(n({}, t), { y: ii(i.yScale.invert(t.y)) })
                    ))
                  : e > i.chartWidth &&
                    ((e = i.chartWidth),
                    i.emit(
                      ...
                      n(n({}, t), {
                        ...
                        y: ii(i.yScale.invert(t.y)),
                      })
                    ));
                var r = i.xScale.invert(e);
                (t.x = e), (t.y = i.yScale(ei(r)));
                var o = ii(i.yScale.invert(t.y)),
                  a = { x: r, y: o };
                (yt(this).on('click', function () {
              ...
              .on('end', function (t) {
                if (!e.preview) {
                  ...
                  !i || i < 0
                    ? (i = 0)
                    : i > e.chartWidth && (i = e.chartWidth);
                  var r = e.xScale.invert(i);
                  t.y = e.yScale(ei(r));
                  var o = { x: r, y: ii(e.yScale.invert(t.y)) };
          ...
          (t = this.preview
            ...
            t
              ...
              .attr('x', function (t) {
                return oi(t.size || 10, e.xScale.invert(t.x));
              })
              .style('text-anchor', function (t) {
                return ri(e.xScale.invert(t.x)) ? 'end' : 'start';
              })
              .attr('y', 5);
        }),
        ...
        (i.prototype.renderBottomLine = function (t) {
          void 0 === t && (t = 5),
            (this.bottomLine = ye(this.xScale).ticks(0).tickSize(0)),
            this.svg
              .append('g')
...
//# sourceMappingURL=hill-chart.umd.js.map
